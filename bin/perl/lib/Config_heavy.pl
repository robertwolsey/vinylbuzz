...
ccname='cl'
ccsymbols=''
ccversion='19.16.27045'
cf_by='Cyber'
cf_email='Cyber@CORER'
cf_time='Fri Sep 10 11:42:07 2021'
charbits='8'
chgrp=''
chmod=''
chown=''
...
ldflags_nolargefiles='-nologo -nodefaultlib -debug -opt:ref,icf -ltcg  -libpath:"c:\perl\lib\CORE"  -machine:AMD64 -subsystem:console,"5.02"'
libs_nolargefiles=''
