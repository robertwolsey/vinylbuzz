...
"MSWin32-x64-multi-thread-10.0.19043.1165" or
	die "Errno architecture (MSWin32-x64-multi-thread-10.0.19043.1165) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEADDRNOTAVAIL WSAESOCKTNOSUPPORT WSAECANCELLED WSAETIMEDOUT
	WSAEINVALIDPROCTABLE WSAELOOP WSAENETDOWN WSAEINVAL
	WSAEINVALIDPROVIDER WSAESTALE WSAENOBUFS WSAEALREADY WSAEHOSTUNREACH
	WSAEDESTADDRREQ WSAENAMETOOLONG WSAEOPNOTSUPP WSAEREFUSED
	WSAEPROTONOSUPPORT WSAEWOULDBLOCK WSAECONNRESET WSAEINPROGRESS
	WSAENETRESET WSAEADDRINUSE WSAENETUNREACH WSAEINTR WSAENOTEMPTY
	WSAEREMOTE WSAEAFNOSUPPORT WSAENOTSOCK WSAEMFILE WSAEDQUOT WSAEFAULT
	WSAESHUTDOWN WSAEPROVIDERFAILEDINIT WSAENOPROTOOPT WSAEISCONN
	WSAETOOMANYREFS WSAECONNABORTED WSAENOMORE WSAEMSGSIZE WSAECONNREFUSED
	WSAEBADF WSAEHOSTDOWN WSAEUSERS WSAEPFNOSUPPORT WSAEACCES WSAEPROCLIM
	WSAENOTCONN WSAEDISCON WSAEPROTOTYPE
    )],
);
